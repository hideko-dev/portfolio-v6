...
const css$b = {
  code: "section.svelte-1y2zmko{width:5.7rem;height:5.5rem;padding-block:5px;padding-inline:5px;position:absolute;right:0;top:2rem;background:var(--bg);border:1px solid var(--border);transform-origin:right top;transition:all 0.15s;user-select:none;border-radius:10px;display:grid;box-shadow:0 0 10px 0 rgba(0, 0, 0, 0.1)}.btn.svelte-1y2zmko{font-size:12px;padding-inline:7px;display:flex;align-items:center;gap:3px;border-radius:5px;transition:all 0.2s;cursor:pointer}.btn.svelte-1y2zmko:hover{background:var(--border)}",
  map: null
};
const ThemeMenu = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section${add_attribute("style", style, 0)} class="svelte-1y2zmko"${add_attribute("this", sectionRef, 0)}>${each(styles, (s) => {
    return `<div class="btn svelte-1y2zmko">${validate_component(ThemeIcon, "ThemeIcon").$$render($$result, { mode: s.theme }, {}, {})} <p>${escape(s.name)}</p> </div>`;
  })} </section>`;
});
...
const css$a = {
  code: ".box.svelte-10zopx{height:1.6rem;position:absolute;z-index:-1;border-radius:100px;background:var(--text);opacity:1;transition:all 0.3s}.navtext.svelte-10zopx{z-index:2}.navs.svelte-10zopx{border-radius:100px;margin-top:10px;display:flex;align-items:center;border:1px solid var(--border);z-index:-1;background:rgba(var(--bg-rgb), 0.2);backdrop-filter:blur(10px)}.nav.svelte-10zopx{display:flex;align-items:center;justify-content:center;text-decoration:none;font-size:15px;color:var(--btn-text);transition:all 0.2s;padding-block:3px;border-radius:100px;position:relative}.nav.svelte-10zopx:hover{color:var(--thin)}.works.svelte-10zopx{width:4rem}.contact.svelte-10zopx{width:4rem}",
  map: null
};
...
const HeaderNav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="navs svelte-10zopx"><div class="box svelte-10zopx"${add_attribute("style", boxStyle, 0)}></div> <a class="nav works svelte-10zopx" href="/works"${add_attribute("style", `${route === "/works" ? navStyle : null}`, 0)}><p class="navtext svelte-10zopx" data-svelte-h="svelte-ky40d9">works</p></a> <a class="nav contact svelte-10zopx" href="/contact"${add_attribute("style", `${route === "/contact" ? navStyle : null}`, 0)}><p class="navtext svelte-10zopx" data-svelte-h="svelte-18oqy4j">contact</p></a> </div>`;
});
const header_svelte_svelte_type_style_lang = "";
const css$9 = {
  code: ".container.svelte-d36vgc{width:35.2rem;display:block}.title.svelte-d36vgc{text-decoration:none;color:var(--text);font-family:'Inter', sans-serif;margin:0 auto 0 0}.name.svelte-d36vgc{font-weight:700;font-size:20px}.sub.svelte-d36vgc{margin-top:2px;font-size:14px}.right.svelte-d36vgc{display:flex;align-items:center;margin:0 0 0 auto}section.svelte-d36vgc{display:flex;justify-content:center;align-items:center;height:11rem;position:fixed;width:100%;padding:2rem;background:rgba(var(--bg-rgb), 0.75);backdrop-filter:blur(10px);z-index:100}.content.svelte-d36vgc{display:flex;align-items:center;justify-content:center}@media(max-width: 700px){section.svelte-d36vgc{padding:0;width:100%}.container.svelte-d36vgc{width:81%}}.theme.svelte-d36vgc{width:1.9rem;height:1.9rem;display:flex;align-items:center;justify-content:center;border-radius:7px;border:1px solid transparent;position:relative;margin-left:12px;transition:all 0.2s}.theme-icon.svelte-d36vgc{width:100%;height:100%;border-radius:7px;display:flex;align-items:center;justify-content:center;transition:all 0.2s}.theme-icon.svelte-d36vgc:hover{background:var(--outline)}.links.svelte-d36vgc{display:flex;align-items:center;justify-content:center;gap:20px}.link.svelte-d36vgc{text-decoration:none;color:var(--text);font-size:20px;transition:all 0.2s}.link.svelte-d36vgc:hover{opacity:0.6}",
  map: null
};
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section class="svelte-d36vgc"><div class="container svelte-d36vgc"><div class="content svelte-d36vgc"><div class="left"><a class="title svelte-d36vgc" href="/" data-svelte-h="svelte-l8z930"><p class="name svelte-d36vgc">hideko</p> <p class="sub svelte-d36vgc">● fullstack engineer</p></a> ${validate_component(HeaderNav, "HeaderNav").$$render($$result, {}, {}, {})}</div> <div class="right svelte-d36vgc"><div class="links svelte-d36vgc">${each(links, (link) => {
    return `<a${add_attribute("href", link.href, 0)} class="link svelte-d36vgc">${validate_component(Fa, "Fa").$$render($$result, { icon: link.icon }, {}, {})}</a>`;
  })}</div> <div class="theme svelte-d36vgc"><div class="theme-icon svelte-d36vgc">${validate_component(ThemeIcon, "ThemeIcon").$$render($$result, {}, {}, {})}</div> ${validate_component(ThemeMenu, "ThemeMenu").$$render($$result, {}, {}, {})}</div></div></div></div> </section>`;
});
const footer_svelte_svelte_type_style_lang = "";
const css$8 = {
  code: "section.svelte-1r1gljf{height:4rem;display:flex;align-items:center;justify-content:center;font-size:14px}",
  map: null
};
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$8);
  return `<section class="svelte-1r1gljf"><p>© ${escape((/* @__PURE__ */ new Date()).getFullYear())} Hideko. All Rights Reserved.</p> </section>`;
});

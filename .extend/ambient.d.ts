...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_microcms_js_sdk: string;
	...
	export const npm_package_dependencies__fontsource_poppins: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_microcms_js_sdk: string;
		...
		npm_package_dependencies__fontsource_poppins: string;
